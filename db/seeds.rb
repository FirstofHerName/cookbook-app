...
CategoryRecipe.create!(recipe_id: 1, category_id: 3)
CategoryRecipe.create!(recipe_id: 1, category_id: 4)
CategoryRecipe.create!(recipe_id: 2, category_id: 1)
CategoryRecipe.create!(recipe_id: 3, category_id: 1)
CategoryRecipe.create!(recipe_id: 3, category_id: 3)
CategoryRecipe.create!(recipe_id: 3, category_id: 4)
CategoryRecipe.create!(recipe_id: 3, category_id: 1)
CategoryRecipe.create!(recipe_id: 4, category_id: 4)
CategoryRecipe.create!(recipe_id: 5, category_id: 4)
CategoryRecipe.create!(recipe_id: 6, category_id: 2)
